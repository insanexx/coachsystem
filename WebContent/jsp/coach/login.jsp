...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <form class="form-signin" action="${pageContext.request.contextPath }/coach/CoachServlet?method=login" method="POST">
      <img class="mb-4" src="${pageContext.request.contextPath }/img/2.png" alt="" width="72" height="72">
 	  <h1 class="jumbotron-heading">私教预订系统</h1>
 	  <h3>教练登录</h3>
      <h1 class="h3 mb-3 font-weight-normal">Please sign in</h1>
      <label for="name" class="sr-only">用户名</label>
      <input type="text" id="name" class="form-control" placeholder="用户名" required autofocus name="name" value="${coach.name }">
      <label for="password" class="sr-only">密码</label>
      <input type="password" id="password" class="form-control" placeholder="密码" required name="password">
      <button class="btn btn-lg btn-primary btn-block" type="submit">登录</button>
      <br/>
      <a href="${pageContext.request.contextPath }/jsp/coach/register.jsp">立即注册</a>
    </form>
  </body>
</html>